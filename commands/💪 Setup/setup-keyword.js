                ...
                return message.reply({
                  embeds: [
                    new Discord.MessageEmbed()
                      ...
                      .setDescription(
                        `You cannot have more then **24** Key Words`.substr(
                          0,
                          2000
                        )
                      )
                                        ...
                                        return message.reply({
                                          embeds: [
                                            new Discord.MessageEmbed()
                                              ...
                                              .setColor(es.wrongcolor)
                                              .setDescription(
                                                `Cancelled the Operation!`.substr(
                                                  0,
                                                  2000
                                                )
                                              )
      ...
      return message.reply({
        embeds: [
          new MessageEmbed()
            ...
            .setDescription(
              eval(
                client.la[ls]["cmds"]["setup"]["setup-keyword"]["variable30"]
              )
            ),
        ],
      });
