      ...
      try{
        ...
        var embeds = [
          ...
          new MessageEmbed()
            ...
            .setImage(message.guild.banner ? message.guild.bannerURL({size: 4096}) : "https://cdn.discordapp.com/attachments/844208282049708153/951171837272936468/editmilrato.png")
            .setTitle(`Start Listening to Music, by connecting to a Voice Channel and sending either the **SONG LINK** or **SONG NAME** in this Channel!`)
            .setDescription(`> *I support <:youtube:1240836962924105870> Youtube, <:spotify:1240839193970606081> Spotify, <:soundcloud:1173649962609950820> Soundcloud and direct MP3 Links!*`)
        ]
