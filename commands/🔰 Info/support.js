...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      let button_public_invite = new MessageButton().setStyle('LINK').setLabel('Invite DJ Tamil').setURL("https://discord.com/oauth2/authorize?client_id=1223271111350030366&permissions=8&scope=bot")
      let button_support_dc = new MessageButton().setStyle('LINK').setLabel('Support Server').setURL("https://discord.gg/NFTtFHcpgZ")
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter('Clan Bot | powered by ABINESH', 'https://imgur.com/jPItIw0.gif')
