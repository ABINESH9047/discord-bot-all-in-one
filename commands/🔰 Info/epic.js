...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if(!serverdata.verifychannel || serverdata.verifychannel.length < 5) return message.reply(`<a:no:1240848440473292810> Verification System not setupped! An Admin can enable it via: \`${prefix}setup-epicgamesverify\``);
