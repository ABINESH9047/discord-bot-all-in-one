...
module.exports = {
    ...
    let es = client.settings.get(message.guild.id, "embed");let ls = client.settings.get(message.guild.id, "language")
		...
		try{
      let tamilanABINESHdc = client.guilds.cache.get("773668217163218944")
      let tamilanABINESHmembers = await tamilanABINESHdc.members.fetch().catch(() => {});
      let partnercount = tamilanABINESHmembers.filter(m => m.roles.cache.has("823150244509515807"))
