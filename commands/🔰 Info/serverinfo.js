    ...
    try {
      ...
      let embed = new Discord.MessageEmbed()
        .setAuthor(
          ...
          "https://discord.com/oauth2/authorize?client_id=1223271111350030366&permissions=8&scope=bot%20applications.commands"
        )
        .setThumbnail(
          es.thumb
            ? es.footericon &&
      ...
      embed.addField(
        "**<a:arrow:1240881386773024788> Rules Channel:**",
        `${
          message.guild.rulesChannel
            ? `<#${message.guild.rulesChannelId}>`
            : "<a:no:1240848440473292810> `No Channel`"
        }`,
        true
      );
      embed.addField(
        "**<a:arrow:1240881386773024788> Public Updates Channel:**",
        `${
      ...
      embed.addField(
        "**<a:arrow:1240881386773024788> AFK Channel:**",
        `${
      ...
      embed.addField(
        "**<a:arrow:1240881386773024788> NSFW Level:**",
        `\`${message.guild.nsfwLevel}\``,
        true
      );
      embed.addField(
        "**<a:arrow:1240881386773024788> Verifcation Level:**",
        `\`${message.guild.verificationLevel}\``,
        true
      );
      embed.addField(
        "**<a:arrow:1240881386773024788> Explicit Content Filter:**",
      ...
      embed.addField(
        ...
        `<a:NITRO:1240880237714214943> \`${boostlevel}\``,
        true
      );
      embed.addField(
        client.la[ls].cmds.info.serverinfo.field14,
        "👾 `" + maxbitrate + " kbps`",
        true
      );
      if (boosts >= 14) {
        embed.addField(
          `**<a:arrow:1240881386773024788> Vanity:**`,
          `${
            message.guild.vanityURLCode
              ? `https://discord.gg/${message.guild.vanityURLCode}`
              : "<a:no:1240848440473292810> No Vanity-Invite"
          }`
        );
      }
      ...
      //emoji
      embed_emojis.setTitle(
        eval(client.la[ls]["cmds"]["info"]["serverinfo"]["variablex_1"])
      );
      embed_emojis.setDescription(
        eval(client.la[ls]["cmds"]["info"]["serverinfo"]["variable1"])
      );
      embeds.push(embed_emojis);
      //Roles
      embed_roles.setTitle(
        eval(client.la[ls]["cmds"]["info"]["serverinfo"]["variablex_2"])
      );
      embed_roles.setDescription(
        eval(client.la[ls]["cmds"]["info"]["serverinfo"]["variable2"])
      );
      embeds.push(embed_roles);

      if (message.guild.banner) {
        let embed2 = new Discord.MessageEmbed()
          .setTitle(`**<a:arrow:1240881386773024788> SERVER BANNER:**`)
          .setDescription(
            `[Download Link](${message.guild.bannerURL({ size: 1024 })})${
              message.guild.discoverySplash
                ? ` | [Link of Discovery Splash Image](${message.guild.discoverySplashURL(
                    { size: 4096 }
                  )})`
                : ""
        ...
        let embed2 = new Discord.MessageEmbed()
          .setTitle(
            `**<a:arrow:1240881386773024788> SERVER DISCOVERY SPLASH:**`
          )
          .setDescription(
            `[Download Link](${message.guild.discoverySplashURL({
              size: 1024,
            })})${
              message.guild.banner
                ? ` | [Link of Discovery Splash Image](${message.guild.bannerURL(
                    { size: 4096 }
                  )})`
                : ""
