  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let embed = new MessageEmbed()
        ...
        .addField("<a:arrow:1240881386773024788> PNG", `[\`LINK\`](${user.displayAvatarURL({format: "png"})})`, true)
        .addField("<a:arrow:1240881386773024788> JPEG", `[\`LINK\`](${user.displayAvatarURL({format: "jpg"})})`, true)
        .addField("<a:arrow:1240881386773024788> WEBP", `[\`LINK\`](${user.displayAvatarURL({format: "webp"})})`, true)
