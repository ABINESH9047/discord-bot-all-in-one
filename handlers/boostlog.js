  ...
  client.on("guildMemberUpdate", async (oM, nM) => {
    ...
    if(settings && settings.log) {
      ...
      let stopBoost = new MessageEmbed()
          ...
          .setColor("RED")
          .setDescription(`<a:Server_Boosts:1173647276586057733> ${nM.user} **stopped Boosting us..** <:Cat_Sad:867722685949804565>`)
      let startBoost = new MessageEmbed()
          .setFooter(client.getFooter("ID: " + nM.user.id))
          .setTimestamp()
          .setAuthor(client.getAuthor(nM.user.tag, nM.user.displayAvatarURL({dynamic: true})))
          .setColor("GREEN")
          .setDescription(`<a:Server_Boosts:1173647276586057733> ${nM.user} **has boosted us!** <a:Light_Saber_Dancce:867721861462229013>`)
