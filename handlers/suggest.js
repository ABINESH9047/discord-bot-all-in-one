...
module.exports = (client) => {
  ...
  client.on("messageCreate", async (message) => {
    ...
    client.settings.ensure(message.guild.id, {
        suggest: {
          channel: "",
          approvemsg: `<a:tick:1173137268727349349> Accepted Idea! Expect this soon.`,
          denymsg: `<:no:1173646354791272448> Thank you for the feedback, but we are not interested in this idea at this time.`,
